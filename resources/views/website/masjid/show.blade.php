        ...
        <div class="bg-white rounded-lg shadow p-6 flex flex-col md:flex-row gap-8">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center gap-2 mb-4">
                    <span class="inline-block px-3 py-1 rounded bg-purple-600 text-white text-xs font-semibold">Kegiatan
                        Dakwah</span>
                ...
                @if($kegiatan->mesjid && $kegiatan->mesjid->alamat)
                    <div class="mt-4 flex gap-4">
                        <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($kegiatan->mesjid->alamat) }}"
                            target="_blank"
                            class="inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold">Lihat
                            di Google Maps</a>
                        <a href="https://www.google.com/maps/dir/?api=1&destination={{ urlencode($kegiatan->mesjid->alamat) }}"
                            target="_blank"
                            class="inline-block px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 font-semibold">Petunjuk
                            Arah</a>
                    </div>
                @endif
                <a href="{{ url()->previous() }}" class="inline-block mt-8 text-blue-600 hover:underline">&larr; Kembali
                    ke
                    jadwal</a>
            </div>
        </div>
